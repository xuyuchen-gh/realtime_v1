...
//        entries.set(HConstants.HBASE_REGIONSERVER_LEASE_PERIOD_KEY,"1200000");
    ...
    public static boolean createTable(String nameSpace,String tableName, String... columnFamily) throws Exception {
    ...
    public static boolean tableIsExists(String tableName) throws Exception {
        Thread.sleep(1000);
        Admin admin = connection.getAdmin();
